...
public class MockedContentAPIProvider {
    ...
    private final Map<String, UrlRequest> urlRequestMap = new HashMap<String, UrlRequest>();

    public MockedContentAPIProvider() {
        contentAPIProvider = mock(ContentAPIProvider.class);
        initializeMockedModelRequests();
        initializeMockedCategoryRequests();
    }

    public void initializeMockedModelRequests() {
...
//                TODO ...
    ...
    public UrlRequest urlRequestByStringUrl(String url){
